<?php
    ...
    $tabs = array(
        array(
            'id'      => 'redux-help-tab-1',
            'title'   => __( 'Theme Information 1', 'misspg' ),
            'content' => __( '<p>This is the tab content, HTML is allowed.</p>', 'misspg' )
        ),
        array(
            'id'      => 'redux-help-tab-2',
            'title'   => __( 'Theme Information 2', 'misspg' ),
            'content' => __( '<p>This is the tab content, HTML is allowed.</p>', 'misspg' )
        )
    );
    ...
    $content = __( '<p>This is the sidebar content, HTML is allowed.</p>', 'misspg' );
